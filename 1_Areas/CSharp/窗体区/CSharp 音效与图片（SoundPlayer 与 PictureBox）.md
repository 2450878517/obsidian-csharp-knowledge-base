---
title: 'C# 音效与图片（SoundPlayer / PictureBox）'
tags: [CSharp, WinForms, 音效与图片]
status: budding
area: CSharp
aliases: [SoundPlayer, PictureBox, 音效播放, 图片显示]
related: [CSharp 窗体控件基础, CSharp 登录系统（窗体跳转与密码隐藏）, CSharp 垃圾回收 GC]
---
...
**相关笔记：** [[CSharp 窗体控件基础|C# 窗体控件基础]] | [[CSharp编程入门_视频笔记#🎬 8月11日下午 — 文件夹与文件操作（增删改查 & TXT读写 & 打包）|C# 文件与文件夹操作]] | [[CSharp 垃圾回收 GC|C# 垃圾回收 GC]] | [[CSharp编程入门_视频笔记|C#编程入门_视频笔记]]
