...
related: [CSharp 面向对象, CSharp 属性, CSharp 静态成员]
---
# C# 访问修饰符
...
- `public` —— 对外开放的入口
- `private` —— 藏起来的内部实现（配合属性保护数据，见 [[CSharp 属性|C# 属性]]）
...
**相关笔记：** [[CSharp 面向对象|C# 面向对象]] | [[CSharp 属性|C# 属性]] | [[CSharp 静态成员|C# 静态成员]] | [[CSharp编程入门_视频笔记|C# 编程入门_视频笔记]]
