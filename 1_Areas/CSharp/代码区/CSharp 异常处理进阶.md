...
related: [CSharp 异常处理, CSharp 调试, CSharp 值类型与引用类型]
---

# C# 异常处理进阶

基础版 [[CSharp 异常处理|C# 异常处理]] 讲了 try-catch 能「抓住错误不崩溃」。这一节是进阶玩法：**怎么分开处理不同类型的错、不管成功失败都要做的事（finally）、还有手动报错（throw）**。
...
**相关笔记：** [[CSharp 异常处理|C# 异常处理]] | [[CSharp 调试|C# 调试]] | [[CSharp 值类型与引用类型|C# 值类型与引用类型]] | [[CSharp编程入门_视频笔记|C#编程入门_视频笔记]]
