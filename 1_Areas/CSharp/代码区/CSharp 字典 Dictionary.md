---
title: 'C# 字典（Dictionary）'
tags: [CSharp, 数据结构, 字典]
status: evergreen
area: CSharp
aliases: [Dictionary, 键值对, KeyValuePair, 字典]
related: [CSharp 列表 List, CSharp 泛型, CSharp 数组, CSharp 字符串操作]
---
...
**相关笔记：** [[CSharp 列表 List|C# 列表 List]] | [[CSharp 泛型|C# 泛型]] | [[CSharp 数组|C# 数组]] | [[CSharp 字符串操作|C# 字符串操作]] | [[CSharp编程入门_视频笔记|C#编程入门_视频笔记]]
