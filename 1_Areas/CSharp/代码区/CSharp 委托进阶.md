---
title: 'C# 委托进阶（Action、Func 与 Lambda）'
tags: [CSharp, 方法, 委托, Lambda]
status: evergreen
area: CSharp
aliases: [Action, Func, Lambda, 匿名函数]
related: [CSharp 委托, CSharp 事件（Event）, CSharp 数组]
---
# C# 委托进阶（Action、Func 与 Lambda）

学完 [[CSharp 委托|C# 委托]] 的基础后，你会发现：每次用委托都要先**声明**（`delegate void WT();`），还得写参数、返回值，太麻烦了！
...
**相关笔记：** [[CSharp 委托|C# 委托]] | [[CSharp 数组|C# 数组]] | [[CSharp 方法|C# 方法]] | [[CSharp编程入门_视频笔记|C#编程入门_视频笔记]]
