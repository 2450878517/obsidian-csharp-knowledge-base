---
title: 'C# JSON 序列化与反序列化（Newtonsoft.Json）'
...
related: [CSharp编程入门_视频笔记, CSharp 面向对象, CSharp 泛型, CSharp 列表 List, CSharp 选择控件补充（ListView 与 ComboBox）]
---
...
- **保存文件**用之前学的 `File.WriteAllText`（[[CSharp编程入门_视频笔记#🎬 8月11日下午 — 文件夹与文件操作（增删改查 & TXT读写 & 打包）|C# 文件与文件夹操作]]），文件后缀 `.json`
...
**相关笔记：** [[CSharp编程入门_视频笔记#🎬 8月11日下午 — 文件夹与文件操作（增删改查 & TXT读写 & 打包）|C# 文件与文件夹操作]] | [[CSharp 面向对象|C# 面向对象]] | [[CSharp 泛型|C# 泛型]] | [[CSharp 列表 List|C# 列表 List]] | [[CSharp 选择控件补充（ListView 与 ComboBox）|C# 选择控件补充（ListView 与 ComboBox）]] | [[CSharp编程入门_视频笔记|C#编程入门_视频笔记]]
