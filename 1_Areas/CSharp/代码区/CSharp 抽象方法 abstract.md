---
title: 'C# 抽象方法（abstract）'
tags: [CSharp, 面向对象, 抽象方法]
status: evergreen
area: CSharp
aliases: [abstract, 抽象类, 抽象方法]
related: [CSharp 虚方法 virtual 与 重写 override, CSharp 面向对象, CSharp 构造函数]
---
# C# 抽象方法（abstract）
...
**相关笔记：** [[CSharp 虚方法 virtual 与 重写 override|C# 虚方法 virtual 与 重写 override]] | [[CSharp 面向对象|C# 面向对象]] | [[CSharp 构造函数|C# 构造函数]] | [[CSharp编程入门_视频笔记|C#编程入门_视频笔记]]
