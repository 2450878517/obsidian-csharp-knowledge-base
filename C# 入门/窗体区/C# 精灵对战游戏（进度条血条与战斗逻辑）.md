...
related: [C# 窗体控件基础, C# 猜拳游戏, C# 音效与图片（SoundPlayer 与 PictureBox）, C# 随机数]
---
# C# 精灵对战游戏（进度条血条与战斗逻辑）
...
- 用 `Application.StartupPath` 拼相对路径（素材跟 exe 一起走），别写死绝对路径（[[C# 文件与文件夹操作]] 里学过）
...
**相关笔记：** [[C# 窗体控件基础]] | [[C# 猜拳游戏]] | [[C# 音效与图片（SoundPlayer 与 PictureBox）]] | [[C# 随机数]] | [[C#编程入门_视频笔记]]
